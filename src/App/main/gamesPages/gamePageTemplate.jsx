    ...
    return(
        <section className="gamePageTemplate-container">
            ...
            <div className="game-description">
                ...
                <div className="game-description-img"><img src={gameDescriptionImg1} alt="game-description"/></div>
                <div className="game-description-img"><img src={gameDescriptionImg2} alt="game-description"/></div>
